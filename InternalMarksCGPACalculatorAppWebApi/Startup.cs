...
services.AddSwaggerGen(s =>
        {
            ...
            {
                Version = "v1",
                Title = "InternalMarksCGPACalculatorApp",
                Description = "InternalMarksCGPACalculatorApp Apis",
...
if(env.IsDevelopment())
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "InternalMarksCGPACalculatorApp");
                    c.RoutePrefix = "";
            ...
            {
                    var basePath = "/InternalMarksCGPACalculatorApp/InternalMarksCGPACalculatorAppWebApi";
                    app.UseSwagger(c =>
                    {
                    ...
                    {
	                    c.RoutePrefix = "";
	                    c.SwaggerEndpoint("/InternalMarksCGPACalculatorApp/InternalMarksCGPACalculatorAppWebApi/swagger/v1/swagger.json", "InternalMarksCGPACalculatorApp");
                    });
